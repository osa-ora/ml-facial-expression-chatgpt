...
tkn pipeline start cicd-gitops-pipeline --param proj-name=$1 --param slack-enabled=true --workspace name=app-workspace,volumeClaimTemplateFile=https://raw.githubusercontent.com/openshift/pipelines-tutorial/pipelines-1.5/01_pipeline/03_persistent_volume_claim.yaml
echo "Done!!"
